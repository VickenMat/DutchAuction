...
const auctionPath = path.resolve(__dirname, '../', 'contracts', 'NFTDutchAuction_ERC20Bids.sol');
...
export const compiledContract = output.contracts['NFTDutchAuction_ERC20Bids.sol'].NFTDutchAuction_ERC20Bids;